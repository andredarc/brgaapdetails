		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Pesquisar Invoces",
									"targetURL": "#brgaapdetails-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brgaapdetails-display": {
								"semanticObject": "brgaapdetails",
								"action": "display",
								"description": "Gerando pesquisa e detalhes e status",
								"title": "Pesquisar Invoces",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=brgaapdetails",
									"url": sap.ui.require.toUrl("brgaapdetails")
								}
							}
						}
					}
